# Adsterra Bot - Google Cloud Windows Setup Script
# This script sets up everything needed to run the Adsterra bot on Google Cloud Windows VM

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Adsterra Bot - Google Cloud Windows Setup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$repoPath = "C:\adsterra"
$repoUrl = "https://github.com/footyamigo/adsterra"
...
Write-Host "      - BrightData password: ql1bol9csls1" -ForegroundColor Yellow
Write-Host "      - AWS credentials (copy from your local .env)" -ForegroundColor Yellow
Write-Host ""
